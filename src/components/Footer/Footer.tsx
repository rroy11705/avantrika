    ...
    <footer className={`relative w-full bg-[#2A0A0D] text-white py-16 md:py-20 lg:py-24 ${className}`}>
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-8">
          ...
          <Link
            href="/coming-soon"
            className="px-8 py-4 bg-[#F5EDE4] text-[#2A0A0D] rounded-lg text-base font-medium hover:bg-white transition-colors duration-300"
          >
            Contact Us
          </Link>
        </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-white/50 text-sm">
              © {currentYear} avantrika. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
